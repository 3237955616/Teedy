...
public class UserRegistrationDao {
    ...
    public List<UserRegistrationDto> findByCriteria(UserRegistrationCriteria criteria, SortCriteria sortCriteria) {
        ...
        StringBuilder sb = new StringBuilder("select r.REG_ID as c0, r.REG_USERNAME as c1, REG_PASSWORD as c2, r.REG_EMAIL as c3, r.REG_DATE as c4, r.REG_STATUS as c5");
